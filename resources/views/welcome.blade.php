...
. ">
								<figcaption class="mask">
									...
									<p>إذا كنت تجد صعوبة في التواصل مع طفلك ولا تجد الطريقة لمعرفة احتياجاته ستتمكن من ذلك عبر البرنامج التدريبي  الذي يستعرض لك جميع احتياجات طفلك الذي يريدها مع دكتور مصطفى أبوسعد
					...
					<div class="container">
						<div class="row">
							...
							<div class="sec-title text-center white wow animated fadeInDown">
								<!--Presentation du docteur mostafa-->
								<h2>مداخلة الدكتور مصطفى</h2>
							</div>
				...
				<div class="overlay">
					<div class="container">
						<div class="row">
							...
							<div class="sec-title text-center white wow animated fadeInDown">
								<h2>اتبعني على الشبكات الخاصة بي
</h2>
								<p>أزرار متابعة بسيطة بشكل جميل لمساعدتك في الحصول على متابعين
</p>
							</div>
			...
			<div class="container">
				<div class="row text-center">
					<div class="footer-content">
						...
						<p>Blue &copy; Copyright 2016. Design and Developed By<a href="http://srikrishnacommunication.com/Giridesigns.html"> Giri Designs</a> </p>
					</div>
				</div>
			</div>
		</footer>
