    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        ...
        -->
          ...
          <table id="fresh-table" class="table">
            <thead>
              ...
              <th data-field="name" data-sortable="true">Libelle</th>
              <th data-field="salary" data-sortable="true">Description</th>
              <th data-field="country" data-sortable="true">Image</th>
              <th data-field="city">Livre</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href='/imagelivre/{{$livres->id}}'>lire</a></td>
                <td><a href='/lirelivre/{{ $livres->id}}'>regarder</a></td>
                <td>{{ $livres->id}}</td>
              </tr>
              @endforeach
            </tbody>
        ...
        <div class="description description-footer">
          ...
          <p>Copyright &copy; 2021 <a href="http://creative-tim.com">Creative Tim</a>, made with <i class="fa fa-heart ct-heart"></i> for a better web.</p>
        </div>
      </div>
    </div>
  </div>
